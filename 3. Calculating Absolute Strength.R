...
E(g1)$width <- ifelse(E(g1)$Weight>=edge_weight_Q3,5,ifelse(E(g1)$Weight>=edge_weight_med,3,1))
V(g1)$size <-15

lab.locs <- radian.rescale(x=1:length(V(g1)), direction=-1, start=0)

plot(g1, layout = layout_in_circle(g1), vertex.label.dist=5,
     vertex.label.degree=lab.locs)

#Distribution statistics
summary(CANZUK_5180$Weight)

edge_data <- rbind(edge_V1,edge_V2, edge_weight, edge_relative_weight, edge_width, edge_median)
write.table(edge_data, file="CANZUK_51_80_Whole_g.csv", row.names = FALSE, col.names = FALSE, sep= ",")
...
hist(CANZUK_5180[CANZUK_5180$In==TRUE,]$Weight, prob=FALSE, xlim=c(0,20), ylim=c(0,3))
...
hist(CANZUK_5180[CANZUK_5180$In==FALSE,]$Weight, prob=FALSE, xlim=c(0,25), ylim=c(0,330))
...
hist(CANZUK_8100[CANZUK_8100$In==FALSE,]$Weight, prob=FALSE, xlim=c(0,450), ylim=c(0,330))
...
hist(CANZUK_8100[CANZUK_8100$In==TRUE,]$Weight, prob=FALSE, xlim=c(0,50), ylim=c(0,3))
...
hist(CANZUK_0120[CANZUK_0120$In==TRUE,]$Weight, prob=FALSE, xlim=c(0,800), breaks=8, ylim=c(0,3))
...
hist(CANZUK_0120[CANZUK_0120$In==FALSE,]$Weight, prob=FALSE, xlim=c(0,4500), ylim=c(0,330), breaks = 15)
...
hist(CANZUK_0120[CANZUK_0120$In==TRUE,]$Weight, prob=FALSE, xlim=c(0,800), ylim=c(0,3))
...
hist(CANZUK_0120[CANZUK_0120$In==FALSE,]$Weight, prob=FALSE, xlim=c(0,4500), ylim=c(0,330))
...
#need to reload CANZUK_5180, CANZUK_8100, and CANZUK_0120 of whole counting accordingly beforehand 
