...
{
  RC <- CANZUK_8100[i,]
  Association_Strength_value <-  RC$Whole_count/(Countries_8100[Countries_8100$Country==RC$Country1,2]*Countries_8100[Countries_8100$Country==RC$Country2,2])
  Association_Strength_list <- rbind(Association_Strength_list, Association_Strength_value)
}
...
{
  RC <- CANZUK_8100[i,]
  Association_Strength_value <-  RC$Fractional_count/(Countries_8100[Countries_8100$Country==RC$Country1,2]*Countries_8100[Countries_8100$Country==RC$Country2,2])
  Association_Strength_list <- rbind(Association_Strength_list, Association_Strength_value)
}
CANZUK_8100 <- cbind(CANZUK_8100,Association_Strength_list)
...
{
  RC <- CANZUK_0120[i,]
  Association_Strength_value <-  RC$Whole_count/(Countries_0120[Countries_0120$Country==RC$Country1,2]*Countries_0120[Countries_0120$Country==RC$Country2,2])
  Association_Strength_list <- rbind(Association_Strength_list, Association_Strength_value)
}
...
{
  RC <- CANZUK_0120[i,]
  Association_Strength_value <-  RC$Fractional_count/(Countries_0120[Countries_0120$Country==RC$Country1,2]*Countries_0120[Countries_0120$Country==RC$Country2,2])
  Association_Strength_list <- rbind(Association_Strength_list, Association_Strength_value)
}
CANZUK_0120 <- cbind(CANZUK_0120,Association_Strength_list)
...
{
  RC <- CANZUK_8100[i,]
  Salton_value <-  RC$Whole_count/(sqrt(Countries_8100[Countries_8100$Country==RC$Country1,2]*Countries_8100[Countries_8100$Country==RC$Country2,2]))
  Salton_list <- rbind(Salton_list, Salton_value)
}
...
{
  RC <- CANZUK_0120[i,]
  Salton_value <-  RC$Whole_count/(sqrt(Countries_0120[Countries_0120$Country==RC$Country1,2]*Countries_0120[Countries_0120$Country==RC$Country2,2]))
  Salton_list <- rbind(Salton_list, Salton_value)
}
...
{
  RC <- CANZUK_0120[i,]
  Salton_value <-  RC$Fractional_count/(sqrt(Countries_0120[Countries_0120$Country==RC$Country1,2]*Countries_0120[Countries_0120$Country==RC$Country2,2]))
  Salton_list <- rbind(Salton_list, Salton_value)
}
CANZUK_0120 <- cbind(CANZUK_0120,Salton_list)
