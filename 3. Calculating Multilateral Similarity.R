...
{
  RC <- CANZUK_8100[i,]
  Ratio_value <-  RC$Whole_count/(Countries_8100[Countries_8100$Country==RC$Country1,2]*Countries_8100[Countries_8100$Country==RC$Country2,2]/Countries_8100_RC_total)
  Ratio_list <- rbind(Ratio_list, Ratio_value)
...
{
  RC <- CANZUK_0120[i,]
  Ratio_value <-  RC$Whole_count/(Countries_0120[Countries_0120$Country==RC$Country1,2]*Countries_0120[Countries_0120$Country==RC$Country2,2]/Countries_0120_RC_total)
  Ratio_list <- rbind(Ratio_list, Ratio_value)
...
{
  RC <- CANZUK_0120[i,]
  Ratio_value <-  RC$Fractional_count/(Countries_0120[Countries_0120$Country==RC$Country1,2]*Countries_0120[Countries_0120$Country==RC$Country2,2]/Countries_0120_RC_total)
  Ratio_list <- rbind(Ratio_list, Ratio_value)
  Expected_value <-  (Countries_0120[Countries_0120$Country==RC$Country1,2]*Countries_0120[Countries_0120$Country==RC$Country2,2]/Countries_0120_RC_total)
  Expected_list <- rbind(Expected_list, Expected_value)
}
